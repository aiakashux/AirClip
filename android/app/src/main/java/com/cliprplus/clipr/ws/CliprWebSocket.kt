package com.cliprplus.clipr.ws
...
/**
 * Persistent WebSocket client for the Clipr+ relay.
 *
 ...
 */
class CliprWebSocket(
    private val wsBaseUrl: String,
    private val deviceToken: String,
    private val listener: CliprWsListener
) {
